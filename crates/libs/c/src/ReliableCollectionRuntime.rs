...
pub unsafe fn Buffer_Release(handle: *mut core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Buffer_Release(handle : *mut core::ffi::c_void));
    unsafe { Buffer_Release(handle as _) }
}
#[inline]
pub unsafe fn CancellationTokenSource_Cancel(cts: *mut core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn CancellationTokenSource_Cancel(cts : *mut core::ffi::c_void));
    unsafe { CancellationTokenSource_Cancel(cts as _) }
}
#[inline]
pub unsafe fn CancellationTokenSource_Release(cts: *mut core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn CancellationTokenSource_Release(cts : *mut core::ffi::c_void));
...
pub unsafe fn ConcurrentQueue_GetCount(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn ConcurrentQueue_GetCount(concurrentqueue : *const core::ffi::c_void, count : *mut i64) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        ConcurrentQueue_GetCount(concurrentqueue, &mut result__)
...
pub unsafe fn PrimaryReplicator_UpdateReplicatorSettings(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn PrimaryReplicator_UpdateReplicatorSettings(primaryreplicator : *const core::ffi::c_void, replicatorsettings : *const TxnReplicator_Settings) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn ReliableCollectionRuntime_Initialize(apiversion: u16) -> windows_core::Result<()> {
    windows_targets::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_Initialize(apiversion : u16) -> windows_core::HRESULT);
...
pub unsafe fn ReliableCollectionRuntime_Initialize2(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_Initialize2(apiversion : u16, standalonemode : windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
...
pub unsafe fn ReliableCollectionRuntime_StartTraceSessions() -> windows_core::Result<()> {
    windows_targets::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_StartTraceSessions() -> windows_core::HRESULT);
...
pub unsafe fn StateProviderEnumerator_AddRef(enumerator: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_AddRef(enumerator : *const core::ffi::c_void));
...
pub unsafe fn StateProviderEnumerator_MoveNext(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_MoveNext(enumerator : *const core::ffi::c_void, advanced : *mut windows::Win32::Foundation:: BOOL, providername : *mut windows_core::PCWSTR, provider : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn StateProviderEnumerator_Release(enumerator: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_Release(enumerator : *const core::ffi::c_void));
...
pub unsafe fn StateProvider_AddRef(stateproviderhandle: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProvider_AddRef(stateproviderhandle : *const core::ffi::c_void));
...
{
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProvider_GetInfo(stateprovider : *const core::ffi::c_void, lang : windows_core::PCWSTR, stateproviderinfo : *mut StateProvider_Info) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        StateProvider_GetInfo(stateprovider, lang.param().abi(), &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn StateProvider_Release(stateproviderhandle: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StateProvider_Release(stateproviderhandle : *const core::ffi::c_void));
    unsafe { StateProvider_Release(stateproviderhandle) }
}
#[inline]
pub unsafe fn StoreKeyEnumerator_AddRef(enumerator: *mut core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_AddRef(enumerator : *mut core::ffi::c_void));
...
pub unsafe fn StoreKeyEnumerator_MoveNext(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_MoveNext(enumerator : *const core::ffi::c_void, advanced : *mut windows::Win32::Foundation:: BOOL, key : *mut windows_core::PCWSTR) -> windows_core::HRESULT);
...
pub unsafe fn StoreKeyEnumerator_Release(enumerator: *mut core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_Release(enumerator : *mut core::ffi::c_void));
...
pub unsafe fn StoreKeyValueEnumerator_MoveNextAsync(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn StoreKeyValueEnumerator_MoveNextAsync(enumerator : *const core::ffi::c_void, cts : *mut *mut core::ffi::c_void, advanced : *mut windows::Win32::Foundation:: BOOL, key : *mut windows_core::PCWSTR, objecthandle : *mut usize, value : *mut Buffer, versionsequencenumber : *mut i64, callback : fnNotifyStoreKeyValueEnumeratorMoveNextAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn StoreKeyValueEnumerator_Release(enumerator: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn StoreKeyValueEnumerator_Release(enumerator : *const core::ffi::c_void));
...
pub unsafe fn Store_AddRef(storehandle: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_AddRef(storehandle : *const core::ffi::c_void));
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_ConditionalRemoveAsync(store : *const core::ffi::c_void, txn : *const core::ffi::c_void, key : windows_core::PCWSTR, timeout : i64, cts : *mut *mut core::ffi::c_void, conditionalversion : i64, removed : *mut windows::Win32::Foundation:: BOOL, callback : fnNotifyRemoveAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_ConditionalUpdateAsync(store : *const core::ffi::c_void, txn : *const core::ffi::c_void, key : windows_core::PCWSTR, objecthandle : usize, bytes : *const core::ffi::c_void, byteslength : u32, timeout : i64, cts : *mut *mut core::ffi::c_void, conditionalversion : i64, updated : *mut windows::Win32::Foundation:: BOOL, callback : fnNotifyUpdateAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_ContainsKeyAsync(store : *const core::ffi::c_void, txn : *const core::ffi::c_void, key : windows_core::PCWSTR, timeout : i64, lockmode : Store_LockMode, cts : *mut *mut core::ffi::c_void, found : *mut windows::Win32::Foundation:: BOOL, callback : fnNotifyContainsKeyAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn Store_GetCount(store: *const core::ffi::c_void) -> windows_core::Result<i64> {
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_GetCount(store : *const core::ffi::c_void, count : *mut i64) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        Store_GetCount(store, &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn Store_Release(storehandle: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_Release(storehandle : *const core::ffi::c_void));
...
pub unsafe fn Store_SetNotifyStoreChangeCallback(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_SetNotifyStoreChangeCallback(stateprovider : *const core::ffi::c_void, callback : fnNotifyStoreChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn Store_SetNotifyStoreChangeCallbackMask(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn Store_SetNotifyStoreChangeCallbackMask(stateproviderhandle : *const core::ffi::c_void, mask : NotifyStoreChangeCallbackMask) -> windows_core::HRESULT);
    unsafe { Store_SetNotifyStoreChangeCallbackMask(stateproviderhandle, mask).ok() }
}
#[inline]
pub unsafe fn Test_UseEnv(enable: bool) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Test_UseEnv(enable : windows::Win32::Foundation:: BOOL));
    unsafe { Test_UseEnv(enable.into()) }
}
#[inline]
pub unsafe fn Transaction_Abort(txn: *const core::ffi::c_void) -> windows_core::Result<()> {
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_Abort(txn : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { Transaction_Abort(txn).ok() }
}
#[inline]
pub unsafe fn Transaction_AddRef(txn: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_AddRef(txn : *const core::ffi::c_void));
...
pub unsafe fn Transaction_CommitAsync(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_CommitAsync(txn : *const core::ffi::c_void, callback : fnNotifyAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        Transaction_CommitAsync(txn, callback, ctx, &mut result__)
            .map(|| core::mem::transmute(result__))
    }
}
#[inline]
pub unsafe fn Transaction_Dispose(txn: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_Dispose(txn : *const core::ffi::c_void));
...
pub unsafe fn Transaction_GetInfo(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_GetInfo(txnhandle : *const core::ffi::c_void, info : *mut Transaction_Info) -> windows_core::HRESULT);
...
pub unsafe fn Transaction_GetVisibilitySequenceNumberAsync(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_GetVisibilitySequenceNumberAsync(txnhandle : *const core::ffi::c_void, sequencenumber : *mut i64, callback : fnNotifyGetVisibilitySequenceNumberCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn Transaction_Release(txn: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn Transaction_Release(txn : *const core::ffi::c_void));
...
pub unsafe fn TxnReplicator_CreateEnumerator(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_CreateEnumerator(txnreplicator : *const core::ffi::c_void, parentsonly : windows::Win32::Foundation:: BOOL, enumerator : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn TxnReplicator_CreateTransaction(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_CreateTransaction(txnreplicator : *const core::ffi::c_void, txn : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub unsafe fn TxnReplicator_GetInfo(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_GetInfo(txnreplicator : *const core::ffi::c_void, info : *mut TxnReplicator_Info) -> windows_core::HRESULT);
...
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_GetOrAddStateProviderAsync(txnreplicator : *const core::ffi::c_void, txn : *const core::ffi::c_void, name : windows_core::PCWSTR, lang : windows_core::PCWSTR, stateproviderinfo : *const StateProvider_Info, timeout : i64, cts : *mut *mut core::ffi::c_void, stateprovider : *mut *mut core::ffi::c_void, alreadyexist : *mut windows::Win32::Foundation:: BOOL, callback : fnNotifyGetOrAddStateProviderAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows::Win32::Foundation:: BOOL) -> windows_core::HRESULT);
    unsafe {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_GetStateProvider(txnreplicator : *const core::ffi::c_void, name : windows_core::PCWSTR, store : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
pub unsafe fn TxnReplicator_Release(txnreplicator: *const core::ffi::c_void) {
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_Release(txnreplicator : *const core::ffi::c_void));
...
pub unsafe fn TxnReplicator_SetNotifyStateManagerChangeCallback(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_SetNotifyStateManagerChangeCallback(txnreplicator : *const core::ffi::c_void, callback : fnNotifyStateManagerChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub unsafe fn TxnReplicator_SetNotifyTransactionChangeCallback(
    ...
    windows_targets::link!("reliablecollectionruntime" "system" fn TxnReplicator_SetNotifyTransactionChangeCallback(txnreplicator : *const core::ffi::c_void, callback : fnNotifyTransactionChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
