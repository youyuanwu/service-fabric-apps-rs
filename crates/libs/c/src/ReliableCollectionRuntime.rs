    ...
    pub mod ServiceFabric {
        pub mod ReliableCollectionRuntime {
            ...
            pub unsafe fn Buffer_Release(handle: *mut core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Buffer_Release(handle : *mut core::ffi::c_void));
                unsafe { Buffer_Release(handle as _) }
            }
            #[inline]
            pub unsafe fn CancellationTokenSource_Cancel(cts: *mut core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn CancellationTokenSource_Cancel(cts : *mut core::ffi::c_void));
                unsafe { CancellationTokenSource_Cancel(cts as _) }
            }
            #[inline]
            pub unsafe fn CancellationTokenSource_Release(cts: *mut core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn CancellationTokenSource_Release(cts : *mut core::ffi::c_void));
            ...
            pub unsafe fn ConcurrentQueue_GetCount(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn ConcurrentQueue_GetCount(concurrentqueue : *const core::ffi::c_void, count : *mut i64) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn PrimaryReplicator_UpdateReplicatorSettings(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn PrimaryReplicator_UpdateReplicatorSettings(primaryreplicator : *const core::ffi::c_void, replicatorsettings : *const TxnReplicator_Settings) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn ReliableCollectionRuntime_Initialize(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_Initialize(apiversion : u16) -> windows_core::HRESULT);
            ...
            pub unsafe fn ReliableCollectionRuntime_Initialize2(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_Initialize2(apiversion : u16, standalonemode : windows_core::BOOL) -> windows_core::HRESULT);
                unsafe {
                    ReliableCollectionRuntime_Initialize2(apiversion, standalonemode.into()).ok()
                }
            }
            #[inline]
            pub unsafe fn ReliableCollectionRuntime_StartTraceSessions() -> windows_core::Result<()>
            {
                windows_core::link!("reliablecollectionruntime" "system" fn ReliableCollectionRuntime_StartTraceSessions() -> windows_core::HRESULT);
            ...
            pub unsafe fn StateProviderEnumerator_AddRef(enumerator: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_AddRef(enumerator : *const core::ffi::c_void));
            ...
            pub unsafe fn StateProviderEnumerator_MoveNext(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_MoveNext(enumerator : *const core::ffi::c_void, advanced : *mut windows_core::BOOL, providername : *mut windows_core::PCWSTR, provider : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn StateProviderEnumerator_Release(enumerator: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StateProviderEnumerator_Release(enumerator : *const core::ffi::c_void));
            ...
            pub unsafe fn StateProvider_AddRef(stateproviderhandle: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StateProvider_AddRef(stateproviderhandle : *const core::ffi::c_void));
            ...
            {
                windows_core::link!("reliablecollectionruntime" "system" fn StateProvider_GetInfo(stateprovider : *const core::ffi::c_void, lang : windows_core::PCWSTR, stateproviderinfo : *mut StateProvider_Info) -> windows_core::HRESULT);
                unsafe {
                    let mut result__ = core::mem::zeroed();
            ...
            pub unsafe fn StateProvider_Release(stateproviderhandle: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StateProvider_Release(stateproviderhandle : *const core::ffi::c_void));
                unsafe { StateProvider_Release(stateproviderhandle) }
            }
            #[inline]
            pub unsafe fn StoreKeyEnumerator_AddRef(enumerator: *mut core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_AddRef(enumerator : *mut core::ffi::c_void));
            ...
            pub unsafe fn StoreKeyEnumerator_MoveNext(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_MoveNext(enumerator : *const core::ffi::c_void, advanced : *mut windows_core::BOOL, key : *mut windows_core::PCWSTR) -> windows_core::HRESULT);
            ...
            pub unsafe fn StoreKeyEnumerator_Release(enumerator: *mut core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StoreKeyEnumerator_Release(enumerator : *mut core::ffi::c_void));
            ...
            pub unsafe fn StoreKeyValueEnumerator_Release(enumerator: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn StoreKeyValueEnumerator_Release(enumerator : *const core::ffi::c_void));
            ...
            pub unsafe fn Store_AddRef(storehandle: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Store_AddRef(storehandle : *const core::ffi::c_void));
            ...
            #[inline]
            pub unsafe fn Store_GetCount(
                store: *const core::ffi::c_void,
            ) -> windows_core::Result<i64> {
                windows_core::link!("reliablecollectionruntime" "system" fn Store_GetCount(store : *const core::ffi::c_void, count : *mut i64) -> windows_core::HRESULT);
                unsafe {
                    let mut result__ = core::mem::zeroed();
            ...
            pub unsafe fn Store_Release(storehandle: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Store_Release(storehandle : *const core::ffi::c_void));
            ...
            pub unsafe fn Store_SetNotifyStoreChangeCallback(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn Store_SetNotifyStoreChangeCallback(stateprovider : *const core::ffi::c_void, callback : fnNotifyStoreChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn Store_SetNotifyStoreChangeCallbackMask(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn Store_SetNotifyStoreChangeCallbackMask(stateproviderhandle : *const core::ffi::c_void, mask : NotifyStoreChangeCallbackMask) -> windows_core::HRESULT);
                unsafe { Store_SetNotifyStoreChangeCallbackMask(stateproviderhandle, mask).ok() }
            }
            #[inline]
            pub unsafe fn Test_UseEnv(enable: bool) {
                windows_core::link!("reliablecollectionruntime" "system" fn Test_UseEnv(enable : windows_core::BOOL));
                unsafe { Test_UseEnv(enable.into()) }
            }
            #[inline]
            pub unsafe fn Transaction_Abort(
                txn: *const core::ffi::c_void,
            ) -> windows_core::Result<()> {
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_Abort(txn : *const core::ffi::c_void) -> windows_core::HRESULT);
                unsafe { Transaction_Abort(txn).ok() }
            }
            #[inline]
            pub unsafe fn Transaction_AddRef(txn: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_AddRef(txn : *const core::ffi::c_void));
            ...
            pub unsafe fn Transaction_CommitAsync(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_CommitAsync(txn : *const core::ffi::c_void, callback : fnNotifyAsyncCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows_core::BOOL) -> windows_core::HRESULT);
                unsafe {
                    let mut result__ = core::mem::zeroed();
            ...
            pub unsafe fn Transaction_Dispose(txn: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_Dispose(txn : *const core::ffi::c_void));
            ...
            pub unsafe fn Transaction_GetInfo(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_GetInfo(txnhandle : *const core::ffi::c_void, info : *mut Transaction_Info) -> windows_core::HRESULT);
            ...
            pub unsafe fn Transaction_GetVisibilitySequenceNumberAsync(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_GetVisibilitySequenceNumberAsync(txnhandle : *const core::ffi::c_void, sequencenumber : *mut i64, callback : fnNotifyGetVisibilitySequenceNumberCompletion, ctx : *const core::ffi::c_void, synchronouscomplete : *mut windows_core::BOOL) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn Transaction_Release(txn: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn Transaction_Release(txn : *const core::ffi::c_void));
            ...
            pub unsafe fn TxnReplicator_CreateEnumerator(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_CreateEnumerator(txnreplicator : *const core::ffi::c_void, parentsonly : windows_core::BOOL, enumerator : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn TxnReplicator_CreateTransaction(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_CreateTransaction(txnreplicator : *const core::ffi::c_void, txn : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
            ...
            pub unsafe fn TxnReplicator_GetInfo(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_GetInfo(txnreplicator : *const core::ffi::c_void, info : *mut TxnReplicator_Info) -> windows_core::HRESULT);
            ...
            where
                P1: windows_core::Param<windows_core::PCWSTR>,
            {
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_GetStateProvider(txnreplicator : *const core::ffi::c_void, name : windows_core::PCWSTR, store : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
                    TxnReplicator_GetStateProvider(txnreplicator, name.param().abi(), store as _)
                        .ok()
                }
            }
            #[inline]
            pub unsafe fn TxnReplicator_Release(txnreplicator: *const core::ffi::c_void) {
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_Release(txnreplicator : *const core::ffi::c_void));
            ...
            pub unsafe fn TxnReplicator_SetNotifyStateManagerChangeCallback(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_SetNotifyStateManagerChangeCallback(txnreplicator : *const core::ffi::c_void, callback : fnNotifyStateManagerChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
            ...
            pub unsafe fn TxnReplicator_SetNotifyTransactionChangeCallback(
                ...
                windows_core::link!("reliablecollectionruntime" "system" fn TxnReplicator_SetNotifyTransactionChangeCallback(txnreplicator : *const core::ffi::c_void, callback : fnNotifyTransactionChangeCallback, cleanupcallback : fnCleanupContextCallback, ctx : *const core::ffi::c_void) -> windows_core::HRESULT);
                unsafe {
            ...
            impl IFabricDataLossHandler {
                pub unsafe fn BeginOnDataLoss < P0, > ( & self , callback : P0 , ) -> windows_core::Result < mssf_com::Microsoft::ServiceFabric::FabricCommon:: IFabricAsyncOperationContext > where P0 :windows_core::Param < mssf_com::Microsoft::ServiceFabric::FabricCommon:: IFabricAsyncOperationCallback > ,{
                    unsafe {
                        let mut result__ = core::mem::zeroed();
                ...
                }                pub unsafe fn EndOnDataLoss < P0, > ( & self , context : P0 , isstatechanged : *mut u8 , ) -> windows_core::Result < ( ) > where P0 :windows_core::Param < mssf_com::Microsoft::ServiceFabric::FabricCommon:: IFabricAsyncOperationContext > ,{
                    unsafe {
            ...
            impl IFabricDataLossHandler_Vtbl {
                pub const fn new<Identity: IFabricDataLossHandler_Impl, const OFFSET: isize>(
                ) -> Self {
            ...
            pub const RetryInterval: TxnReplicator_Settings_Flags =
                TxnReplicator_Settings_Flags(1u64);
            ...
            pub const StateManagerChangeKind_Add: StateManagerChangeKind =
                StateManagerChangeKind(0u32);
            ...
            pub const StateProvider_Kind_ConcurrentQueue: StateProvider_Kind =
                StateProvider_Kind(2u32);
            ...
            pub const TransactionChangeKind_Commit: TransactionChangeKind =
                TransactionChangeKind(0u32);
            #[repr(C)]
            #[derive(Clone, Copy, Debug, Default, PartialEq)]
